...
module.exports = {
  ...
  networks: {
    ...
    rinkeby: {
      url: "https://rinkeby.infura.io/v3/c487892f7ed443a88ee0d5751831e4b4", // <---- YOUR INFURA ID! (or it won't work)
    ...
    goerli: {
      url: "https://goerli.infura.io/v3/2DXjZuhFmuSZjESIhgfr0dyiIEs", // <---- YOUR INFURA ID! (or it won't work)
